        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            class="text-xs font-semibold tracking-wide text-left text-black uppercase border-b dark:border-gray-700 bg-blue-100 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <tbody class="bg-blue-100 divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-600 dark:text-white ">
                            ...
                            <td class="px-4 py-3 text-xs">
                                <span
                                    class="px-2 py-1 font-semibold leading-tight text-black bg-red-600 rounded-md dark:text-red-100 dark:bg-red-700">
                                    {{ $item->status }}
                                </span>
                            </td>
