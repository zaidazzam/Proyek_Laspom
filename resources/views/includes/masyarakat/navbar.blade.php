<header class="z-10 py-4 bg-red-600 shadow-md dark:bg-red-800">
    <div class="container flex items-center justify-end h-full px-6 mx-auto text-white dark:text-white">
        <!-- Mobile hamburger -->
        ...
        <div class="flex justify-center flex-1">
            <a class="inline-flex items-center text-sm mr-5 font-semibold  transform transition hover:scale-125   "
                href="{{ url('user')}}">
            ...
            <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 "
                ...
                <span class="ml-4">Detail Pelaporan</span>
            </a>
        ...
        <ul class="flex items-center flex-shrink-2 space-x-6">
            ...
            <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                    ...
                    aria-haspopup="true">
                    <img class="object-cover w-8 h-8 rounded-full" src="{{ asset('img/man.png')}}" alt=""
                        aria-hidden="true" />
                </button>
